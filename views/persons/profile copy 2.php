            ...
            <div class="card-body">
                <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                        ...
                        <span class="float-right">' . ($fingerprintCount > 0 ? '<span class="badge badge-success"><i class="fas fa-check"></i> ' . $fingerprintCount . ' Captured</span>' : '<span class="badge badge-secondary">Not Captured</span>') . '</span>
                    </li>
                    <li class="list-group-item">
                        <b><i class="fas fa-user-circle"></i> Face</b>
                        <span class="float-right">' . ($faceCount > 0 ? '<span class="badge badge-success"><i class="fas fa-check"></i> ' . $faceCount . ' Captured</span>' : '<span class="badge badge-secondary">Not Captured</span>') . '</span>
                    </li>
                </ul>
                <a href="' . url('/persons/' . $person['id'] . '/biometrics') . '" class="btn btn-info btn-block">
                    <i class="fas fa-fingerprint"></i> ' . (($fingerprintCount > 0 || $faceCount > 0) ? 'View' : 'Capture') . ' Biometrics
                </a>';
