            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Schedule Duty</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Duty Assignment Details</h3>
                </div>
                <form action="<?= url('/duty-roster/store') ?>" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Duty Date <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="duty_type" class="form-control">
                                        <option value="Regular" <?= old('duty_type') == 'Regular' ? 'selected' : '' ?>>Regular</option>
                                        <option value="Overtime" <?= old('duty_type') == 'Overtime' ? 'selected' : '' ?>>Overtime</option>
                                        <option value="Special Assignment" <?= old('duty_type') == 'Special Assignment' ? 'selected' : '' ?>>Special Assignment</option>
                                        <option value="Court Duty" <?= old('duty_type') == 'Court Duty' ? 'selected' : '' ?>>Court Duty</option>
                                        <option value="Training" <?= old('duty_type') == 'Training' ? 'selected' : '' ?>>Training</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="supervisor_id" class="form-control select2">
                                        ...
                                        <?php foreach ($officers as $officer): ?>
                                            <option value="<?= $officer['id'] ?>" 
                                                <?= old('supervisor_id') == $officer['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Schedule Duty
                        </button>
...
$(document).ready(function() {
    ...
    $('#station_id').change(function() {
        ...
        if (stationId) {
            window.location.href = `/duty-roster/create?station=${stationId}`;
        }
    });
});
</script>
